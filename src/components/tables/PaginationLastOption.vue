<template>
  <div class="is-flex is-justify-content-center">
    <div class="is-flex is-align-items-center">
      <Icon 
        class="button-step py-3 px-1 mr-1 is-clickable"
      ...
      <Icon 
        class="button-step py-3 px-1 is-clickable"
        :class="!isPrevControlsActive && !showButtonsOnBounderies ? 'is-invisible' : 'control-items-active'"
        @click="goToPrev"
        icon="backward-step"
      ></Icon>
    ...
    <div class="is-flex">
      <span v-for="page, key in pagination" :key="key">
        <Transition name="slide">
          <button 
            v-if="page" 
            class="page py-3 px-4 m-1 is-clickable" 
            type="button" 
    ...
    <div class="is-flex is-align-items-center ml-1">
      ...
      <Icon 
        class="button-step py-3 px-1 m-1 is-clickable"
        :class="!isNextControlsActive && !showButtonsOnBounderies ? 'is-invisible' : 'control-items-active'"
        @click="goToLast"
        icon="forward"
      >
